...
export const AuthProvider: React.FC<AuthProviderProps> = ({ children }) => {
    ...
    useEffect(() => {
        // Escuchar cambios en localStorage (para cuando client.ts limpia el token)
        const handleStorageChange = () => {
            const currentToken = localStorage.getItem("token");
            const currentUser = localStorage.getItem("userData");
            const currentCompany = localStorage.getItem("companyData");
            ...
            if (currentUser) {
                try {
                    ...
                    console.error(
                        "Error al parsear userData en storage change:",
                        error,
                    );
                    setUser(null);
                }
            ...
            if (currentCompany) {
                try {
                    ...
                    console.error(
                        "Error al parsear companyData en storage change:",
                        error,
                    );
                    setCompanyData(null);
                }
        ...
        // También verificar periódicamente el token por seguridad (cada 30 segundos)
                    ...
                    tables: floor.tables?.map((table) =>
                        table.id === updatedTable.id
                            ? {
                                  ...
                                  statusColors:
                                      updatedTable.statusColors !== undefined
                                          ? updatedTable.statusColors
                                          : table.statusColors,
                                  currentOperationId:
                                  ...
                                  occupiedById:
                                      updatedTable.occupiedById !== undefined
                                          ? (updatedTable.occupiedById ??
                                            undefined)
                                          : table.occupiedById,
                                  userName:
                                      updatedTable.userName !== undefined
                                          ? (updatedTable.userName ?? undefined)
                                          : table.userName,
                              }
                            : table,
                        ...
                        ? {
                              ...
                              statusColors:
                                  updatedTable.statusColors !== undefined
                                      ...
                                      : table.statusColors,
                              currentOperationId:
                                  updatedTable.currentOperationId !== undefined
                                      ? (updatedTable.currentOperationId ??
                                        undefined)
                                      : table.currentOperationId,
                              occupiedById:
