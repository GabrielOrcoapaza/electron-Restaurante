...
export const ALL_PERMISSION_CODES: string[] = [
  ...
  'products.edit_prices_delivery',
  'recipes.manage',
  'reports.sales',
  'reports.cancellations',
  'reports.sold_products',
  'reports.user_sales',
  'reports.driver_delivery',
  'reports.client_sales',
  'config.manage',
  'kitchen.view',
  'purchases.manage',
  'kardex.view',
...
const LABELS_ES: Record<string, string> = {
  ...
  'products.edit_prices_delivery': 'Editar precio en Delivery',
  ...
  'reports.driver_delivery': 'Reporte de motorizados',
  'reports.client_sales': 'Reporte de clientes',
...
const DESCRIPTIONS_ES: Record<string, string> = {
  ...
  'products.edit_prices_delivery': 'Cambiar el precio de un ítem al hacer una venta en Delivery',
  'recipes.manage': 'Agregar, editar y quitar ingredientes en recetas de platos',
  ...
  'reports.driver_delivery': 'Ver entregas delivery por motorizado',
  'reports.client_sales': 'Ver ventas por cliente agrupadas por método de pago',
