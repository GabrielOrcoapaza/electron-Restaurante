...
import { downloadCategorySalesReport } from './reportExcelExports';
...
const ReportCategorySales: React.FC = () => {
  ...
  const handleExportExcel = async () => {
    if (!categories.length) {
      showToast('No hay datos para exportar en este periodo.', 'warning');
      return;
    }

    try {
      const result = await downloadCategorySalesReport(categories, summary, { startDate, endDate });
