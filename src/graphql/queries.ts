...
export const GET_COMPANIES_FOR_CARTA_DIGITAL = gql`
    query GetCompaniesForCartaDigital {
        allCompanies {
            id
            ruc
            denomination
...
`;
export const GET_COMPANY_FOR_CARTA = gql`
    query GetCompanyForCarta($companyId: ID!) {
